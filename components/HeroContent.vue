  ...
  <div class="pt-24">
    ...
    >
      ...
      >
        ...
        <nuxt-link
          to="/charts"
          class="mx-auto lg:mx-0 hover:bg-gray-800 hover:text-white bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg"
        >
          Subscribe
        </nuxt-link>
      </div>
      <!--Right Col-->
      <div class="w-full md:w-3/5 py-6 text-center md:flex md:justify-end">
